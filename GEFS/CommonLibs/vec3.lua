-- Adopted from the MAT vector library
-- https://github.com/bjornbytes/maf
-- MIT License

--See also: https://github.com/excessive/cpml/blob/master/modules/vec3.lua
...
vec3 = {
  ...
  __index = {
    ...
    scaleToLength = function(v, l, out)
      out = out or v
      local len = v:length()
      return len == 0 and v or v:scale(l / len, out)
    end,
